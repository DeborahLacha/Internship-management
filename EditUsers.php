...
$fri = $_POST['mobile'];
$num = $_POST['role'];
  $query = "INSERT INTO users(`name`,`sex`,`Email`,`mobile`,`password`,`role`) VALUES('$mon','$tue','$wed','$fri','$pas','$num')";
    $res = $con->query($query);
    if($res){
      echo "Inserted";
    }else{
    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="System Admin.html">
                    <h5>System Admin Dashboard</h5>
                </a>
                <a class="navbar-brand brand-logo-mini" href="System Admin.html"><img src="images/SNNPR BoSIT.jpg"
                        alt="logo" /></a>
            </div>
            ...
            <div class="main-panel">
                                  ...
                                  <div class="form-group">
                                    <label class="col-sm-3 col-form-label">Role:</label>
                                      <select class="form-control" id="exampleFormControlSelect2" name="role">
                                        ...
                                        <option>halafi</option>
                                        <option>sera kifl</option>
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © SNNPR
                            BoSIT 2022. All rights reserved.</span>
