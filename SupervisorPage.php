...
<body>
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Welcome Mr.Supervisor!</h4>
                </div>
                <div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              ...
              <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Attach Files</h4>
                    <input type="file" name="Input Files" id="">
                  </div>
                </div>
              </div>
            ...
            <a class="btn btn-success" href="AddStudent.php"><i class="mdi mdi-home mr-2"></i>Add Students List</a>
  ...
  <script src="E:\Dashboard\chart.js"></script>
